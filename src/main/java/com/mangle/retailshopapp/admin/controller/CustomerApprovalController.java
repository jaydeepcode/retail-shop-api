...
public class CustomerApprovalController {
    ...
    public ResponseEntity<?> getPendingCustomers() {
        try {
            List<WaterPurchaseParty> pending = waterPartyRepository.findByRegistrationStatus("PENDING");
    ...
    public ResponseEntity<?> approveCustomer(@PathVariable Long waterPartyId, 
        ...
        try {
            WaterPurchaseParty party = waterPartyRepository.findById(waterPartyId)
                    .orElseThrow(() -> new RuntimeException("Customer not found"));
            
            User user = userRepository.findById((long) party.getUserId())
    ...
    public ResponseEntity<?> getAllCustomers() {
        try {
            ...
            List<WaterPurchaseParty> customers = waterPartyRepository.findApprovedAndActiveCustomers();
